  ...
  return (
    <ThemeProvider theme={{ darkMode }}>
      ...
      >
        ...
        <MenuHeader variant="h6">LOCATION & AMENITIES</MenuHeader>
        <CategoryList>
      ...
      >
        ...
        <MenuHeader variant="h6">Welcome to Fliqa</MenuHeader>
        ...
        <List>
          ...
          {showCategoriesInDrawer && (
            <StyledListItem onClick={toggleCategoryDrawer}>
              ...
              <StyledListItemText
                primary="LOCATION AND AMENITIES"
                style={{ padding: "5px" }}
              />
              <ArrowRightIcon />
            </StyledListItem>
        ...
        <MenuFooter>
          <Typography variant="caption" color="textSecondary" align="center">
            Buy a plesent working space at Fliqa Coworking Space. We are happy
            to serve you.
          </Typography>
        </MenuFooter>
      </SideDrawer>
